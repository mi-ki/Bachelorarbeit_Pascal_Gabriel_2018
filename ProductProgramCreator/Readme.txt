...
-Methoden, Variablen und Klassen die definiert werden müssen alle einen einzigartigen Namen haben, der auch mit keiner externen Methode, Variable oder Klasse die aufgerufen wird �bereinstimmen, darf
...
'Typ' muss ersetzt werden durch den entsprechenden Namen, im Moment gibt es nur 'default'. Das 'label' muss an Anfang und Endannotation �bereinstimmen. In diesem Rahmen muss das 'label' einzigartig sein. 'Typ' und 'label' m�ssen mit den zu 
verwebenden Annotationen des zweiten Programms übereinstimmen
...
default ruft einfach die normale Verwebung wieder auf auf den markierten Teilblücken, nützlich falls man z.B. eine while-Schleife �berspringen m�chte oder �hnliches.
