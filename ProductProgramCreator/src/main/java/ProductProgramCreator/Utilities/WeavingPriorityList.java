...
public class WeavingPriorityList {
    ...
    /**
     * Initiates the priority list with the order returned from the lists iterator
     * @param rules The rule list
     */
    public WeavingPriorityList (LinkedList<String> rules) {
        this.rulePriority = new LinkedList();
    ...
    /**
     * Checks wether the rule in the first argument has higher priority than the
     * rule in the second parameter.
     * Rules that are not part of this list will be treated as, the same, lowest
     * priority.
     ...
     */
    public boolean hasHigherPriority(String ruleToCheck, String ruleToCompareTo) {
